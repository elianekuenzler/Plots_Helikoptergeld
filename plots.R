...
plot(bip_DE_percent,xaxt="n" , ylim=c(90,300),type="o", main="Prozentualeveränderung des BIP Deutschland und BIP Griechenland im Vergleich mit der Geldmenge M3", xlab="Jahr", ylab="Delta zu 1997 (%)", pch=15, col=color3[1])
lines(bip_GR_percent,type="o", pch=16,  col=color3[3])
lines(moneySupply_M3_percent,type="o", pch=17,  col=color3[2])
axis(1, at = seq(1997, 2015, by = 1))
legend("topleft", inset=0.05 ,1, c("BIP Deutschland","BIP Griechenland","Geldmenge M3"), bty = "n",col=c(color3[1],color3[3],color3[2]), pch=15:17, lty=(1))
dev.off()
...
plot(publicDebt_DE, type="o",xaxt="n" ,ylim=c(0,200), main="Staatsschulden", xlab="Jahr", ylab="Staatsschuldenquote (in % vom BIP)", pch=15, col=color2[1])
lines(publicDebt_GR,type="o", pch=16, col=color2[2])
axis(1, at = seq(1997, 2015, by = 1))
legend("topleft", inset=0.05 ,1, c("Deutschland","Griechenland"), bty = "n",col=color2 , pch=c(15,16), lty=(1))
dev.off()
...
plot(publicDebt_DE, type="o",xaxt="n",xlim=c(2008,2025) ,ylim=c(0,300), main="Staatsschulden Trend", xlab="Jahr", ylab="Staatsschuldenquote (in % vom BIP)", pch=15, col=color2[1])
lines(publicDebt_GR,type="o", pch=16, col=color2[2])
